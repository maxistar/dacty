...
const LAYOUT = [
    ...
    [
        ...
        { legends: ["W","ц"], positions: ["center","bottomLeft"] },
        { legends: ["E","1","у"], positions: ["center","bottomRight","bottomLeft"] },
        { legends: ["R","2","к"], positions: ["center","bottomRight","bottomLeft"] },
        { legends: ["T","3","е"], positions: ["center","bottomRight","bottomLeft"] },
    ...
    [
        ...
        { legends: ["S","ы"], positions: ["center","bottomLeft"] },
        { legends: ["D","4","в"], positions: ["center","bottomRight","bottomLeft"] },
        { legends: ["F","5","а"], positions: ["center","bottomRight","bottomLeft"] }, // примеры 1.5u
        { legends: ["G","6","п"], positions: ["center","bottomRight","bottomLeft"] },
    ...
    [
        ...
        { legends: ["X","ч"], positions: ["center","bottomLeft"] },
        { legends: ["C","7","с"], positions: ["center","bottomRight","bottomLeft"] },
        { legends: ["V","8","м"], positions: ["center","bottomRight","bottomLeft"] },
        { legends: ["B","9","и"], positions: ["center","bottomRight","bottomLeft"] },
